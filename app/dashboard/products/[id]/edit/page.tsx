...
export default function EditProductPage() {
    ...
    try {
      ...
      if (data.success) {
        ...
        setFormData({
          ...
          packingWeight: product.packingWeight?.toString() || "",
        ...
        if (existingImages.length > 0) {
          setAdditionalImagesUrls(existingImages);
  ...
  const handleAdditionalImagesUpload = async (files: FileList | File[]) => {
    ...
    const startIndex = additionalImagesUrls.length;
